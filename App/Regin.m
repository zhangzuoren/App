...
@interface Regin ()<WKNavigationDelegate,WKUIDelegate,WKScriptMessageHandler>
...
- (void)viewDidLoad {
    ...
    NSURLRequest *Request_zsj = [NSURLRequest requestWithURL:[NSURL URLWithString:@"http://puser.zjzwfw.gov.cn/sso/usp.do?action=mobileRegisterUser&type=1"] cachePolicy:NSURLRequestUseProtocolCachePolicy timeoutInterval:10];
    //加载网页
